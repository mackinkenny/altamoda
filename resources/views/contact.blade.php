...
@section('content')
    ...
    <div class="container">
        <div class="row p-5">
            <div class="col-6">
                <h2 class="font-weight-bold Montserrat mb-5">Наши контакты</h2>
                <p class="Montserrat">
                ...
                <h2 class="font-weight-bold Montserrat my-5">Наши соц.сети</h2>
                <a href="https://www.instagram.com/altamoda_bishkek/?hl=ru" style="color:black;">
